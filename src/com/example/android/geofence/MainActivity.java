	...
	private void setUpMapIfNeeded() {
		...
		if (mMap1 == null) {
			mMap1 = ((SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map1))
					.getMap();
			if (mMap1 != null) {
				mMap1.setOnMapLongClickListener(new OnMapLongClickListener() {
		...
		if (mMap2 == null) {
			mMap2 = ((SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map2))
					.getMap();
			if (mMap2 != null) {
				mMap2.setOnMapLongClickListener(new OnMapLongClickListener() {


					@Override
					public void onMapLongClick(LatLng point) {
						mLatitude2.setText(mLatLngFormat.format(point.latitude),TextView.BufferType.EDITABLE);
